...
public class tech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for webview...
        webView = (WebView) findViewById(R.id.webview_tech);

        webView.setWebViewClient(new WebViewClient());

        webView.loadUrl("https://www.techspot.com/");
        ...
        TECHimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent goToMain = new Intent(tech.this, MainActivity.class);


                Pair[] pairs = new Pair[2];
                pairs[0] = new Pair<View, String>(TECHimage, "imageTransitionTECH");
                pairs[1] = new Pair<View, String>(webView, "textTransitionTECH");


                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(tech.this, pairs);
